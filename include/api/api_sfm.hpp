...
class ITexture {
 public:
  ...
  virtual void update(const Color *pixels, unsigned int width,
                      unsigned int height, unsigned int x, unsigned int y) = 0;
...
class IRenderWindow {
 public:
  ...
  static std::unique_ptr<IRenderWindow> create(unsigned int width,
                                               unsigned int height,
...
class IRectangleShape : public IShape {
 public:
  ...
  static std::unique_ptr<IRectangleShape> create(unsigned int width = 0,
                                                 unsigned int height = 0);
  static std::unique_ptr<IRectangleShape> create(const vec2u &size = vec2u(0,
                                                                           0));
};
...
class IEllipseShape : public IShape {
 public:
  ...
  static std::unique_ptr<IEllipseShape> create(unsigned int width = 0,
                                               unsigned int height = 0);
  static std::unique_ptr<IEllipseShape> create(const vec2u &size = vec2u(0, 0));
  static std::unique_ptr<IEllipseShape> create(
      unsigned int
          radius);  // creates ellipse with width == height == raduis - circle
};
...
class Mouse {
 public:
  ...
  static void setPosition(const vec2i &position,
                          const IRenderWindow *relative_to);
};
